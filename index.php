...
<form>
    ...
    <input style=" width: 180px;" class="class_consumo" type="text" placeholder=" HORAS">
  ...
  <label style="font-size: 7pt;" for="user">VALOR TOTAL:</label>&nbsp;&nbsp;
  <input style="width: 50px; margin-bottom: 3px; font-size: 7pt; padding-left: 3px;" id="user" name="user" type="text" placeholder="TOTAL"/>
  ...
  <textarea class="class_ob" type="text" placeholder="Observações"></textarea>
		...
		<p style="font-size: 7pt; margin-bottom: 5px; text-align: center;">A POUSADA BAMBU AGRADECE A PARCERIA</p>
