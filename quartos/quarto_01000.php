...
<form>
    ...
    <hr>
    <br>
    <input style=" width: 310px;" class="class_consumo" type="text" placeholder=" HORAS">
  ...
  <textarea class="class_ob" type="text" placeholder="Observações"></textarea>
		...
		<p style="font-size: 8pt; margin-bottom: 5px; text-align: center;">A POUSADA BAMBU AGRADECE A PARCERIA</p>
